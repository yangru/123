                    ...
                    "table":{
                        ...
                        "dim":{"region_name":{
                            render:function(me, val, href, colNum){
                                ...
                                return "<img src=\"/resources/images/icons/geo/"+(data.x_axis.country_icon == '' ? "other" : data.x_axis.country_icon)+".png\"/>"+(data.x_axis.country_name+(data.x_axis.region_name && data.x_axis.region_name || ""));
                            }
                        }},//
                        /*"indicator":{//
