(function(factory){
                    ...
                    "table":{
                        ...
                        "dim":{"os_type_name":{
                            render:function(me, val, href, colNum){
                                ...
                                return "<img src=\"/resources/images/icons/os/"+data.x_axis.os_icon+".png\"/>"+data.x_axis.os_type_name;
                            }
                        }},//
                        /*
                        "indicator":{//
    ...
    OsGrid.prototype.constructor = OsGrid;

    return function(config){
        return new OsGrid(config);
    };
