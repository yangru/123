(function(factory){
    ...
    function GutmContentGrid(config){
        var privateConfig = {
            "ready":false,
                            ...
                            "trend":{
                                ...
                                "config":{
                                    ...
                                    "chartsControl":{
                                        ...
                                        "category":{
                                            "items":[
                                                {"name":"","type":"gutm_content"}//
                                            ]
                                        },
                                        //类型的维度字段
                                        "dimension":{
                                            "gutm_content":"gutm_content_name"//
                                        },
                                        //可选择的指标
                                        "indicator":{
    ...
    GutmContentGrid.prototype.constructor = GutmContentGrid;

    return function(config){
        return new GutmContentGrid(config);
    };
