(function(factory){
            ...
            render:function(){
                ...
                this.commonGrid = new commonGrid({
                    ...
                    "table":{
                        ...
                        "dim":{"browser_type_name":{
                            render:function(me, val, href, colNum){
                                var data = me.model.toJSON();
                                return "<img src=\"/resources/images/icons/browser/"+data.x_axis.browser_icon+".png\"/>"+data.x_axis.browser_type_name;
                            }
                        }},//
                        /*
                        "indicator":{//
    ...
    BrowserGrid.prototype.constructor = BrowserGrid;

    return function(config){
        return new BrowserGrid(config);
    };
