(function(factory){
    ...
    function PageChannelGrid(config){
        var privateConfig = {
            "ready":false,
                    ...
                    "table":{
                        ...
                        "dim":{"channel_name":{
                            render:function(me, val, href, colNum){
                                ...
                                return data.x_axis.channel_name;
                            }
                        }},//
                        /*"indicator":{//
                            ...
                            "trend":{
                                ...
                                "config":{
                                    ...
                                    "chartsControl":{
                                        ...
                                        "category":{
                                            "items":[
                                                {"name":"","type":"page_channel"}//
                                            ]
                                        },
                                        //类型的维度字段
                                        "dimension":{
                                            "page_channel":"channel_name"//
                                        },
                                        //可选择的指标
                                        "indicator":{
    ...
    PageChannelGrid.prototype.constructor = PageChannelGrid;

    return function(config){
        return new PageChannelGrid(config);
    };
