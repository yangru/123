define(function(require,exports,module){
    ...
    function Search(config){
        ...
        var privateConfig = {
            ...
            /*销毁*/
            destroy:function(){
                this.$el.find("input,button").unbind();
                this.$el.remove();
            },
            /*搜索*/
            search:function(){
        ...
        var viewsConfig = $.extend(true,{
            ...
            "readOtherDir":false,
            /*模板*/
            "tpl":'<input type="text" class="setSeachInput {text}" placeholder="{placeholder}" data-type="keyword" value="" /><button type="button" class="btn {button}" data-type="submit" ><span>搜索</span></button><input type="reset" class="btn {reset}" data-type="reset" value="'+LANG("还原")+'" />'
