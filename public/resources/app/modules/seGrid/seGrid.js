(function(factory){
                    ...
                    "table":{
                        ...
                        "dim":{"se_name":{
                            render:function(me, val, href, colNum){
                                ...
                                return "<img src=\"/resources/images/icons/se/"+data.x_axis.se_icon+".png\"/>"+data.x_axis.se_name;
                            }
                        }},//
                        /*"indicator":{//
    ...
    SeGrid.prototype.constructor = SeGrid;

    return function(config){
        return new SeGrid(config);
    };
