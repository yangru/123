(function(factory){
    ...
    function GutmSourceGrid(config){
        var privateConfig = {
            "ready":false,
                            ...
                            "trend":{
                                ...
                                "config":{
                                    ...
                                    "chartsControl":{
                                        ...
                                        "category":{
                                            "items":[
                                                {"name":"","type":"gutm_source"}//
                                            ]
                                        },
                                        //类型的维度字段
                                        "dimension":{
                                            "gutm_source":"gutm_source_name"//
                                        },
                                        //可选择的指标
                                        "indicator":{
    ...
    GutmSourceGrid.prototype.constructor = GutmSourceGrid;

    return function(config){
        return new GutmSourceGrid(config);
    };
