(function(factory){
    ...
    function Referer_urlGrid(config){
        var privateConfig = {
            "ready":false,
            ...
            render:function(){
                ...
                this.condition = this.currentCondition || (this.rowData?this._getCondition(this.rowData,this.noPrevCondition?null:this.prevCondition):"");
                            ...
                            "trend":{
                                ...
                                "config":{
                                    ...
                                    "chartsControl":{
                                        ...
                                        "category":{
                                            "items":[
                                                {"name":"","type":"referer_url"}//
                                            ]
                                        },
                                        //类型的维度字段
                                        "dimension":{
                                            "referer_url":"referer_url_name"//
                                        },
                                        //可选择的指标
                                        "indicator":{
            ...
            _getCondition:function(rowData, prevCondition){
                ...
                for(var _n in rowData["keys"]){
                    //根据pageUrlGrid的subGrid做特殊化处理
                    if(_n === "page_url_id"){
                        _par += "entrance_url_id|"+rowData["keys"][_n]+",";
                    }else{
    ...
    Referer_urlGrid.prototype.constructor = Referer_urlGrid;

    return function(config){
        return new Referer_urlGrid(config);
    };
