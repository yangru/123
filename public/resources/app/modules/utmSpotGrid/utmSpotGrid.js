(function(factory){
            ...
            render:function(){
                ...
                this.commonGrid = new commonGrid({
                    ...
                    "table":{
                        ...
                        "dim":{"utm_spot_position":{},"utm_spot_channel":{},"utm_spot_website":{}},//
                        /*"indicator":{//
                            "default":["utm_spot_channel","utm_spot_website","pageviews","sessions","visitors","new_visitors","avg_staytime","avg_loadtime","bounce_rate","active_visitors"],
                            "all":["utm_spot_channel","utm_spot_website","pageviews","sessions","visitors","new_visitors","old_visitors","avg_staytime","avg_loadtime","avg_pageviews","bounces","bounce_rate","reserve0","reserve1","reserve2","reserve3","reserve4","new_pageviews","active_visitors"]
                        },*/
                        "tableBtn":{
                            "page":{
                                "area":"utm_spot_position",
    ...
    UtmSpotGrid.prototype.constructor = UtmSpotGrid;

    return function(config){
        return new UtmSpotGrid(config);
    };
