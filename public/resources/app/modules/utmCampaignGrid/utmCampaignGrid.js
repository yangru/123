(function(factory){
    ...
    function UtmCampaignGrid(config){
        var privateConfig = {
            "ready":false,
    ...
    UtmCampaignGrid.prototype.constructor = UtmCampaignGrid;

    return function(config){
        return new UtmCampaignGrid(config);
    };
