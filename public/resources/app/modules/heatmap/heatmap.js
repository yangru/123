    ...
    var heatmapFactory = (function(){
        ...
        store.prototype = {
            ...
            addDataPoint: function(x,y,count){
                ...
                data[x][y]+=(!isNaN(count) && count<3 )?1:count;
        ...
        heatmap.prototype = {
            ...
            init: function(){
                    ...
                    canvas.width = acanvas.width = this.get("width") || element.style.width.replace(/px/,"") || me.getWidth(element);
                    me.set("width", canvas.width);
                    canvas.height = acanvas.height = this.get("height") || element.style.height.replace(/px/,"") || me.getHeight(element);
                    ...
                    me.get("debug") && document.body.appendChild(acanvas);
            ...
            drawAlpha: function(x, y, count){
                    ...
                    rgr.addColorStop(0, 'rgba(0,0,0,'+((count)?(count===1 && me.store.max === 1 && 5)||(count/me.store.max):'0.1')+')');  
