(function(factory){
    ...
    function GutmCampaignGrid(config){
        var privateConfig = {
            "ready":false,
            "plugin":["indicator","pager","amount","export","export_sub","search","diggGrid"],
            "refreshConfig": {},
                            ...
                            "trend":{
                                ...
                                "config":{
                                    ...
                                    "chartsControl":{
                                        ...
                                        "category":{
                                            "items":[
                                                {"name":"","type":"gutm_campaign"}//
                                            ]
                                        },
                                        //类型的维度字段
                                        "dimension":{
                                            "gutm_campaign":"gutm_campaign_name"//
                                        },
                                        //可选择的指标
                                        "indicator":{
    ...
    GutmCampaignGrid.prototype.constructor = GutmCampaignGrid;

    return function(config){
        return new GutmCampaignGrid(config);
    };
