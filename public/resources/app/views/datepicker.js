define(function(require,exports,module){
    ...
    function Datepicker(config){
        ...
        */
        ...
        var privateConfig = {
            "tpl":{
                "common":'<div class="dateBtns"><span class="G-buttonGroup"><input type="button" id="gotoToday" class="btn" value="'+LANG("今天")+'" /><input type="button" id="gotoYesterday" class="btn" value="'+LANG("昨天")+'" /><input type="button" id="gotoBefyesterday" class="btn" value="'+LANG("前天")+'" /><input type="button" id="gotoLastWeek" class="btn" value="'+LANG("上周同期")+'" /><input type="button" id="gotoLastSeven" class="btn" value="'+LANG("最近7天")+'" /><input type="button" id="gotoLastThirty" class="btn" value="'+LANG("最近30天")+'" /><input type="button" id="gotoCurrentMonth" class="btn" value="'+LANG("本月")+'" /></span><span class="G-buttonGroup"><input type="button" id="gotoBeforeDay" class="btn" value="'+LANG("前一天")+'" /><input type="button" id="gotoNextDay" class="btn" value="'+LANG("后一天")+'" /></span><span class="G-buttonGroup"><input type="text" class="btn dateInput" class="xlarge" id="dateInput" readonly /></span><input type="button" id="gotoQuery" class="primary" value="'+LANG("查询")+'" /></div>',
            ...
            "fn":{
                ...
                bindChoseDate:function(){
                    ...
                    function setDate(begin, end, type){
                        ...
                        if (!type) type = that.fn.getType(begin, end);
                    ...
                    var type = this.fn.getType(getTimestamp(this.theDate.beginDate), getTimestamp(this.theDate.endDate));
