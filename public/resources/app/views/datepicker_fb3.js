define(function(require,exports,module){
    ...
    function datepicker_fb3(config){
        /*
            el:$(".Ex_export"),
        ...
        */
        ...
        var privateConfig = {
            "tpl":{
                ...
                "common":'<div class="dateBtns"><span class="G-buttonGroup"><input type="text" class="btn dateInput" class="xlarge" id="dateInput" readonly /></span><input type="button" id="gotoQuery" class="btn primary" value="'+LANG("查询")+'" /></div>',
            ...
            initialize:function(){
                ...
                //this.fn.bindCal.call(this);
                //this.fn.bindChoseDate.setDate(privateConfig.theDate.beginDate,privateConfig.theDate.endDate,false);
            ...
            "fn":{
                ...
                buildChoseDate:function(){
                    ...
                    /*初始化*/
                   //console.log(this.theDate.beginDate)
    ...
    datepicker_fb3.prototype.constructor = datepicker_fb3;

    return {
        init:function(config){
            return new datepicker_fb3(config);
        }
    };
