...
class YiiBase
{
	...
	{
		//if(YII_DEBUG)
			//self::log($msg,CScribeLogRoute::LEVEL_TRACE,$category);
	}
	 ...
	 */
	/*
	public static function log($msg,$level=CScribeLogRoute::LEVEL_INFO,$category='application')
	{
		if(self::$_logger===null)
			self::$_logger=new CScribeLogRoute;
		if(YII_DEBUG && YII_TRACE_LEVEL>0 && $level!==CScribeLogRoute::LEVEL_PROFILE)
		{
	...
	public static function log($module_name, $function_name, $msg, $level='INFO') {
		self::$_logger=new CScribeLogRoute;
		self::$_logger->log($module_name, $function_name, $msg, $level);
	}
	...
	{
		//self::log('begin:'.$token,CScribeLogRoute::LEVEL_PROFILE,$category);
	}
	...
	{
		//self::log('end:'.$token,CScribeLogRoute::LEVEL_PROFILE,$category);
	}
	...
	public static function getLogger()
	{
		if(self::$_logger!==null)
			...
			return self::$_logger=new CScribeLogRoute;
	}
	...
	private static $_coreClasses=array(
		...
		'CScribeLogRoute' => '/logging/CScribeLogRoute.php',
