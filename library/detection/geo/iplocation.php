...
class IpLocation {
    ...
    function getlocation($ip, $separator = 0) {
        ...
        if (!isset($location['region']) || !isset($location['country']) ||
        	$location['region'] == "纯真网络" || $location['country'] == " CZ88.NET") {  // CZ88.NET表示没有有效信息
            $location['region'] = "00";
        }
        if (!isset($location['city']) ||
        	$location['city'] == " CZ88.NET") {
            $location['city'] = "";
        }
        return $location;
    }
